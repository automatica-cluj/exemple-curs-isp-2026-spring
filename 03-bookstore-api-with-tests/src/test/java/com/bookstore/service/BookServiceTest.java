...
class BookServiceTest {
    ...
    class Create {
        ...
        void savesAndReturnsResponse() {
            BookRequest request = new BookRequest("Clean Code", 1L, "9780132350884", new BigDecimal("39.99"));
            Author author = createAuthor(1L, "Robert", "Martin");
        ...
        void throwsNotFoundForInvalidAuthorId() {
            BookRequest request = new BookRequest("Clean Code", 999L, "9780132350884", new BigDecimal("39.99"));
            when(bookRepository.existsByIsbn("9780132350884")).thenReturn(false);
    ...
    class Update {
        ...
        void updatesAllFieldsIncludingAuthor() {
            ...
            BookRequest request = new BookRequest("Effective Java", 2L, "9780134685991", new BigDecimal("45.00"));
        ...
        @Test
        @DisplayName("throws ResponseStatusException when ISBN changes to existing one")
        void throwsConflictWhenIsbnChangesToExistingOne() {
            Author author = createAuthor(1L, "Robert", "Martin");
            Book existing = createBook(1L, "Clean Code", author, "9780132350884", new BigDecimal("39.99"));
            BookRequest request = new BookRequest("Clean Code", 1L, "9780134685991", new BigDecimal("39.99"));
