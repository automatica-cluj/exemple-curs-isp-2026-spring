...
public class Device {
    ...
    public LocalDateTime getOtaLastAttempt() {
        return otaLastAttempt;
    }

    public void setOtaLastAttempt(LocalDateTime otaLastAttempt) {
        this.otaLastAttempt = otaLastAttempt;
    }
